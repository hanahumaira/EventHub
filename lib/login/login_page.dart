  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        Container(
          margin: EdgeInsets.symmetric(horizontal: 10), // Add margin for spacing from the screen edges
        ...
        ),// Add some vertical spacing between the password field and the submit button
        //forgot password
             Row(
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          ...
          style: ElevatedButton.styleFrom(
            primary: Colors.purple, // Set the button color
          ),
          child: Text(
            'Login',
            style: TextStyle(
